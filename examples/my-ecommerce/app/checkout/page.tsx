...
const providers = [
  {
    ...
    icon: '🌅',
    description:
      'Israeli invoicing & payment platform. Supports credit cards, Bit, bank transfers, and more. Automatically generates tax invoices.',
  ...
  },
  {
    ...
    icon: '💳',
    description:
      'Leading Israeli payment gateway. Specializes in credit card processing with installment support and 3D Secure.',
      ...
      <div className="provider-grid">
        {providers.map((provider) => (
          <div
            ...
            onClick={() => !loading && handleCheckout(provider.id)}
            style={{ opacity: loading && loading !== provider.id ? 0.5 : 1 }}
          >
